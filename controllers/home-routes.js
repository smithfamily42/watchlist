...
router.get('/towatch', (req, res) => { // This is a new route to put both movies and shows on the same page. needs to be connected to Sequelize
  const data = {
    movies: [],
    shows: [],
    pagetitle: 'Watchlist',
